package me.vakosta.proxima.domain.highlights
...
import me.vakosta.proxima.domain.common.TOKEN_COLORS
import me.vakosta.proxima.domain.common.lifetimes.Lifetime
import me.vakosta.proxima.domain.highlights.syntaxmanager.KotlinSyntaxManager
import me.vakosta.proxima.domain.highlights.syntaxmanager.SyntaxManager
...
class TextState(
    ...
    private fun getTokenParams(tokenType: Int): me.vakosta.proxima.data.CharParameters =
            me.vakosta.proxima.data.CharParameters(
