...
import me.vakosta.proxima.presentation.utils.isRelevant
...
class EditorState(
    ...
    var charCoordinates: MutableList<me.vakosta.proxima.data.CharCoordinates> = mutableListOf()
    ...
    private fun getCharAbsolutePosition(x: Float, y: Float): Int? =
            charCoordinates
                .binarySearch(me.vakosta.proxima.data.CharCoordinates(x, y))
